...
/**
 * This function prints any number of strings to the shell output stdout.
 * The last argument of this function MUST be 0 or NULL.
 * 
 * Usage: print_stdout("print ", "this ", "string.\n", 0);
 */
...
/**
 * Debugging function that prints the argument number and argument of all args
 * in argv.
 * 
...
/**
 * Debugging function that prints the argument number and argument of all
 * environment varialbes passed in envp.
 * 
 * @param envp [input] array of environment variables in name=value form.
 */
